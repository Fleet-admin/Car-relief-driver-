...
import { 
  ...
  UserCheck, UserX, Image as ImageIcon, Check, X, Loader2, Upload 
} from 'lucide-react';
          ...
          <div id="driver-form-overlay" className="fixed inset-0 bg-neutral-900/85 backdrop-blur-sm flex items-center justify-center p-4 z-[9999] animate-fade-in">
            ...
            >
              ...
              <form onSubmit={handleFormSubmit} className="p-5 space-y-4">
                ...
                {/* Driver Photo Link */}
                <div>
                  <label className="text-[10px] font-bold text-neutral-500 uppercase block mb-1">Driver Image (URL or Local Upload)</label>
                  ...
                  {photo && (
                    <div className="mt-2.5 flex items-center gap-3 bg-neutral-50 border border-neutral-150 p-2.5 rounded-xl max-w-xs">
                      ...
                      <img src={photo} alt="Driver preview" referrerPolicy="no-referrer" className="h-8 object-contain rounded" />
                      <button 
                        type="button" 
                        onClick={() => setPhoto('')} 
